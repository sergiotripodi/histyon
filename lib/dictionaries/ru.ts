export const ru = {
  ...
  auth: {
    ...
    updatePassword: {
      ...
      errorWeak: "Пароль не соответствует требованиям безопасности.",
    ...
    deleted: {
      ...
      subheading: "Нам жаль видеть вас уходящим.",
      message: "Ваш аккаунт успешно удалён. Все персональные данные, пациенты, анализы и файлы были безвозвратно удалены с наших серверов.",
  ...
  dashboard: {
    ...
    settings: {
      ...
      danger: {
        title: "Опасная зона",
        subtitle: "Это действие необратимо и удаляет все данные.",
        deleteBtn: "Удалить аккаунт",
        deleteDesc: "Навсегда удаляет ваш аккаунт, всех пациентов, все анализы и все сохранённые файлы.",
        modal: {
          title: "Удалить ваш аккаунт",
          warning: "Вы собираетесь безвозвратно удалить:",
          items: [
            "Ваш аккаунт и медицинский профиль",
            "Всех зарегистрированных пациентов",
            "Все анализы и тикеты",
            "Все файлы, хранящиеся в облаке"
          ],
          irreversible: "Это действие необратимо и не может быть отменено.",
          passwordLabel: "Подтвердите, введя ваш пароль",
          confirmBtn: "Удалить навсегда",
          cancelBtn: "Отмена",
          deleting: "Удаление...",
          errorWrong: "Неверный пароль. Попробуйте снова.",
          errorGeneric: "Ошибка при удалении. Попробуйте снова."
        }
      }
    }
  },

export const ar = {
  ...
  auth: {
    ...
    updatePassword: {
      ...
      errorWeak: "كلمة المرور لا تستوفي متطلبات الأمان.",
      errorSame: "يجب أن تكون كلمة المرور الجديدة مختلفة عن الحالية.",
      errorUpdateFailed: "تعذر تحديث كلمة المرور. حاول مرة أخرى.",
      errorDefault: "حدث خطأ."
    },
    deleted: {
      heading: "تم حذف الحساب",
      subheading: "يؤسفنا مغادرتك.",
      message: "تم حذف حسابك بنجاح. تمت إزالة جميع البيانات الشخصية والمرضى والتحليلات والملفات بشكل دائم من خوادمنا.",
  ...
  dashboard: {
    ...
    settings: {
      ...
      danger: {
        title: "منطقة الخطر",
        subtitle: "هذا الإجراء لا رجعة فيه ويزيل جميع البيانات.",
        deleteBtn: "حذف الحساب",
        deleteDesc: "يحذف نهائياً حسابك وجميع المرضى وجميع التحليلات وجميع الملفات المخزنة.",
        modal: {
          title: "حذف حسابك",
          warning: "أنت على وشك الحذف الدائم لـ:",
          items: [
            "حسابك وملفك الطبي",
            "جميع المرضى المسجلين",
            "جميع التحليلات والتذاكر",
            "جميع الملفات المخزنة على السحابة"
          ],
          irreversible: "هذا الإجراء لا رجعة فيه ولا يمكن التراجع عنه.",
          passwordLabel: "أكد بإدخال كلمة مرورك",
          confirmBtn: "حذف نهائياً",
          cancelBtn: "إلغاء",
          deleting: "جاري الحذف...",
          errorWrong: "كلمة المرور غير صحيحة. حاول مرة أخرى.",
          errorGeneric: "خطأ أثناء الحذف. حاول مرة أخرى."
        }
      }
    }
  },
